...
const AboutUs = () => {
  return (
    <div>
      <div className='pb-8 flex items-center justify-center w-screen h-2/4'>
        <div className='bg-white border shadow-sm px-4 py-3 rounded-lg w-10/12'>
          ...
          <p className='text-gray-800 text-sm mt-2 leading-normal md:leading-relaxed'>
            <br />A KPRODUTORA é uma empresa que pensa além de um simples vídeo.
            Trazemos agilidade e qualidade para você se conectar melhor com seu
            público. Com uma equipe especializada, Trabalhamos com produção de
            vídeos institucionais, promocionais, perfis políticos, eventos,
            documentários, comerciais, programas de TV (abertura e/ou
            corporativa) e para mídias digitais (websites e redes sociais). Com
            profissionalismo e dedicação, levamos ao mercado produções
            diferenciadas e com os melhores equipamentos do mercado. Atuamos em
            todas as etapas da produção de um vídeo. Captação, edição e
